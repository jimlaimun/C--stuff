...
public:
	...
	virtual int GetXCentre() { return m_iCurrentScreenX; /*+ m_iStartDrawPosX + m_iDrawWidth/2;*/ }
	/** Get the Y centre position of the object */
	virtual int GetYCentre() { return m_iCurrentScreenY; /*+ m_iStartDrawPosY + m_iDrawHeight/2;*/ }

	virtual int GetCurrentScreenX() { return m_iCurrentScreenX+m_iStartDrawPosX + m_iDrawWidth/2;}

	virtual int GetCurrentScreenY() { return m_iCurrentScreenY+m_iStartDrawPosX + m_iDrawWidth/2;}
